...
export function NewTweetContent({tweet, tweetData, deleteTweet}: TweetContent) {
  ...
  return (
    <div className="mb-4 break-inside-avoid rounded-xl border bg-white shadow-md">
      <div className="flex-column w-full p-8 md:flex">
      ...
      <div className="border-t border-t-slate-300 bg-slate-100 p-8 py-6">
        {tweet.tags?.length ? (
